...
assert(mainJs.includes('function pfCollectAvailableYears_'), 'PF year dropdown uses wide default range');
assert(mainJs.includes('for (let y = now + 1; y >= 2000; y--) years.add(String(y))'), 'PF year fallback range');
